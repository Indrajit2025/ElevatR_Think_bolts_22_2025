...
app = Flask(__name__)
WHEREBY_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJodHRwczovL2FjY291bnRzLmFwcGVhci5pbiIsImF1ZCI6Imh0dHBzOi8vYXBpLmFwcGVhci5pbi92MSIsImV4cCI6OTAwNzE5OTI1NDc0MDk5MSwiaWF0IjoxNzYwOTgzMTQ5LCJvcmdhbml6YXRpb25JZCI6MzI3MzI5LCJqdGkiOiI4YTIxZjA2ZC1mNGVhLTRmNzAtOGVmNy00NjRjZjBhZjViZjIifQ.SRcdCCMcQ9UlpP_0dYYKgIu_Hjs1EeXinpquzhQ5AUs"
#                                                                       CONFIGURATION
UPLOAD_FOLDER = 'static/uploads'
ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'gif'}
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:pass1234@localhost/bput15'
...
def get_recommendations(student_id):
    ...
    # Hybrid Scoring System                           take cgpa and skills and projects  upload      
    recommendations = []
...
def get_fit_score_for_application(student_id, job_id):
    ...
    # 1. Prepare Data for Cosine Similarity
    student_skills = ' '.join(json.loads(student.skills) if student.skills else [])
    student_projects_text = ' '.join([p.description for p in student.projects if p.description])
    student_doc = f"{student_skills} {student_projects_text}"
...
if __name__ == '__main__':
    ...
    app.run(debug=True, port=8000)                # i am so tired , for to present on presentation , i am going to sleep